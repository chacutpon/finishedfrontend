      ...
      {quizGame?.questions && (
        <div>
          <Typography variant="h5" sx={{ color: '#1976d2', fontFamily: 'Sarabun, sans-serif', mb: 2 }}>
            ข้อที่ {currentQuestionIndex + 1}: {quizGame.questions[currentQuestionIndex].title}
          </Typography>
          ...
          <Stack direction="row" justifyContent="space-between" mt={2}>
            ...
            <Button onClick={handleNext} disabled={currentQuestionIndex === quizGame.questions.length - 1} variant="outlined" color="primary">
              ข้อถัดไป
            </Button>
          </Stack>
        </div>
