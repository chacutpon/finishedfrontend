...
const CreateQuizGame = () => {
  ...
  <List>
    {quizGames
      .filter((quizGame) => !selectedSection || quizGame.section === selectedSection) // กรอง quizGames ตาม section ที่เลือก
      .map((quizGame) => (
          ...
          >
            ...
            <Stack direction="row" spacing={2} alignItems="center">
              <IconButton
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  handleDeleteQuizGame(quizGame.id);
                }}
                color="error"
              >
                <DeleteIcon />
