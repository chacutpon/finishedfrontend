...
import WaitAskingGame from "./components/pages/User/WaitAskingGame";
import IntroduceUserPage from "./components/pages/User/Introduce";
...
import OldQuestion from "./components/pages/Teacher/OldQuestion";
import IntroduceTeacherPage from "./components/pages/Teacher/Introduce";
...
import GamePlayAsking from "./components/pages/Game/Asking/GamePlayAsking";
import Endofclass from "./components/pages/Game/Question/Endofclass";
...
import SeePointAsking from "./components/pages/Game/Asking/SeePointAsking";
import SeeQuestion from "./components/pages/Game/Question/Seequestion";
...
import GamePinAsking from "./components/pages/Game/Asking/GamePinAsking"
  ...
  return (
      ...
      <Header/>
        ...
        ></Route>
          ...
          <Route
          path="/user/index/wait-askinggame"
          element={
            <UserRoute>
              <WaitAskingGame/>
            </UserRoute>
        ...
        ></Route>
         <Route
          path="/user/index/play-asking-game"
          element={
            <UserRoute>
              <GamePlayAsking/>
            </UserRoute>
        ...
        ></Route>
          ...
          <Route
          path="/teacher/manage-teacher/introduce"
          element={
            <TeacherRoute>
              <IntroduceTeacherPage/>
            </TeacherRoute>
          }
        ></Route>
        ...
        <Route
          path="/teacher/manage-teacher/old-question"
          element={
            <TeacherRoute>
              <OldQuestion />
            </TeacherRoute>
        ...
        ></Route>  
          ...
          <Route
          path="/teacher/create/asking-game/game-pin"
          element={
            <TeacherRoute>
              <GamePinAsking />
            </TeacherRoute>
        ...
        <Route
          path="/teacher/create/asking-game/see-point"
          element={
            <TeacherRoute>
              <SeePointAsking />
            </TeacherRoute>
